...
if (isset($_POST['submit'])) {
    ...
    $sql1 = "INSERT INTO inventory2 (location, requested, ordered, itemNumber, itemCode, brand, category, itemDesc_1, itemDesc_2, itemDesc_3, price, units, totalstockValue, image)
